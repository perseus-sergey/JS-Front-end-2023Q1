...
export const constantsClasses = {
  ...
  TRACK_CAR_WINNER_TAG: 'track__car-winner',
  CAR: 'car',
  ...
  BTN_CREATE_CARS: 'btn-create-cars',
  ...
  PAGIN_WRAPPER: 'pagination-wrapper',
  BTN_PAGIN_LEFT: 'btn-pagination-left',
  BTN_PAGIN_RIGHT: 'btn-pagination-right',
  BTN_PAGIN_LAST: 'btn-pagination-last',
